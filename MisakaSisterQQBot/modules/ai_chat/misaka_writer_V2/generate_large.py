...
config_path=os.path.join(current_file_dir, 'models/config-misaka.json')#config路径
vocab_path=os.path.join(current_file_dir, 'models/vocab-misaka.txt')#词表路径
model_path=os.path.join(current_file_dir, 'models/古言.h5')#模型路径
